...
function list_blocks()
{
    ...
    $side_descs = [0 => _AM_SBLEFT, 1 => _AM_SBRIGHT, 3 => _AM_CBLEFT, 4 => _AM_CBRIGHT, 5 => _AM_CBCENTER];
    ...
    foreach (array_keys($block_arr) as $i) {
        ...
        echo "<tr valign='top'><td class='$class'>$name</td><td class='$class'>$title</td><td class='$class' align='center'>$side_desc</td><td class='$class' align='center'>$weight</td><td class='$class' align='center' nowrap>$visible</td><td class='$class' align='right'><a href='$xoops_system_url/admin.php?fct=blocksadmin&amp;op=edit&amp;bid=$bid' target='_blank'>"
             . _EDIT
             . "</a></td></tr>\n";
